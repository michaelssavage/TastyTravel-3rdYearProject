...
[Searching For A Place To Meet](#search-page)                                                                                               <div align="right"> 5. </div>
...
<a name="overview"></a>
# Overview 
TastyTravel aims to allow the user to search for either restaurants, bars, or cafes that two people could meet at. The app works best for urban areas. 
For this manual, we will pretend it is the user’s location and their friend’s location. The user successfully finds places to meet by doing the following steps;
...
2.  The about page will help you learn how to use the map and provides contact information. We recommend reading it before searching to get a good understanding of the app.  
